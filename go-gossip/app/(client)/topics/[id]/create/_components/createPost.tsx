...
import { postFormSchema } from "@/app/(client)/posts/zod";
import { handleError } from "@/app/(client)/posts/utils";
import useCreatePost from "@/app/(client)/posts/_hooks/useCreatePost";
import { useRouter } from "next/navigation";

export default function CreatePost(ModifyFormProps: {
  submitURL: string;
  post?: z.infer<typeof postFormSchema>;
}) {
  const router = useRouter();
  const { mutate } = useCreatePost(ModifyFormProps.submitURL, router);
